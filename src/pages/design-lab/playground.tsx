...
const COMMUNITY_LINKS = [
    ...
    { to: LAB_ROUTES.events, title: "Events", blurb: "Workshops, meetups, and career events near you." },
                    ...
                    <div key={isSearching ? "results" : "grid"} className="joy-swap mt-8">
                        {!isSearching ? (
                            freshLoading ? (
                                ...
                                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    {freshJobs.map((job, i) => (
                                        <Link
                                            key={job.id}
                                            to={LAB_ROUTES.jobDetail(job.id)}
                            ...
                            <div>
                                ...
                                <Link
                                    to={`${LAB_ROUTES.jobs}?search=${encodeURIComponent(debouncedQuery.trim())}`}
