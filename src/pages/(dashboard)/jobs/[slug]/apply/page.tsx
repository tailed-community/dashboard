...
export default function ApplyJobPage() {
  ...
  async function getJobInformation() {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Failed to access job information");
      }
        ...
        <div className="w-full max-w-4xl mx-auto grid gap-8 md:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-muted-foreground mb-6">
              To ensure a seamless application experience, we need to verify
              your identity first.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Continue your application anytime, even on different devices
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 mr-2 text-primary mt-0.5" />
                <div>
                  <h3 className="font-medium">Auto-fill your application</h3>
                  <p className="text-sm text-muted-foreground">
                    We'll use your profile information to speed up the process
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Stand out to employers with a verified application
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="w-full">
            ...
            <CardFooter>
              <div className="flex items-center w-full text-xs text-muted-foreground">
                ...
                <p>
                  Your information is securely encrypted. See our{" "}
  ...
  // Confirmation view
  if (isSubmitted) {
    return <ApplicationConfirmation jobData={jobData} tokenInfo={tokenInfo} />;
  }
