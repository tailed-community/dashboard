...
// https://firebase.google.com/docs/auth/admin/manage-sessions - revoke tokens
// createUserWithEmailAndPassword - https://firebase.google.com/docs/auth/web/start
// onAuthStateChanged
// onIdTokenChanged
// https://firebase.google.com/docs/auth/admin/verify-id-tokens
// https://firebase.google.com/docs/rules

// div interface is used to extend the div element

interface LoginWithSAMLProps extends React.ComponentProps<"div"> {
  onChangeLoginType: () => void;
}

export function LoginWithSAML({
  className,
  onChangeLoginType,
  ...props
}: LoginWithSAMLProps) {
  const handleLogin = (event: FormEvent<HTMLFormElement>) => {
    ...
    const provider = new SAMLAuthProvider("saml.tailed");
          ...
          <form className="flex flex-col gap-6" onSubmit={handleLogin}>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-balance text-muted-foreground">
                {m.login_to_your_organization_account()}
              </p>
            </div>
