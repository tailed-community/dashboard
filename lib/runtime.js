...
export const isServer = (_b = (_a = import.meta.env) === null || _a === void 0 ? void 0 : _a.SSR) !== null && _b !== void 0 ? _b : typeof window === 'undefined';
/**
...
export let getLocale = () => {
    ...
    if (serverAsyncLocalStorage) {
        const locale = (_a = serverAsyncLocalStorage === null || serverAsyncLocalStorage === void 0 ? void 0 : serverAsyncLocalStorage.getStore()) === null || _a === void 0 ? void 0 : _a.locale;
        if (locale) {
            return locale;
        }
    }
    for (const strat of strategy) {
        if (TREE_SHAKE_COOKIE_STRATEGY_USED && strat === "cookie") {
            ...
            strat === "localStorage" &&
            !isServer) {
            locale = (_b = localStorage.getItem(localStorageKey)) !== null && _b !== void 0 ? _b : undefined;
        }
...
export let setLocale = (newLocale, options) => {
    const optionsWithDefaults = Object.assign({ reload: true }, options);
...
export let getUrlOrigin = () => {
    var _a, _b;
    if (serverAsyncLocalStorage) {
        return (_b = (_a = serverAsyncLocalStorage.getStore()) === null || _a === void 0 ? void 0 : _a.origin) !== null && _b !== void 0 ? _b : "http://fallback.com";
    }
...
export const extractLocaleFromRequest = (request) => {
    ...
    for (const strat of strategy) {
        if (TREE_SHAKE_COOKIE_STRATEGY_USED && strat === "cookie") {
            locale = (_b = (_a = request.headers
                .get("cookie")) === null || _a === void 0 ? void 0 : _a.split("; ").find((c) => c.startsWith(cookieName + "="))) === null || _b === void 0 ? void 0 : _b.split("=")[1];
        }
...
export function extractLocaleFromCookie() {
    ...
    const locale = match === null || match === void 0 ? void 0 : match[2];
    if (isLocale(locale)) {
        return locale;
    }
    return undefined;
...
export function extractLocaleFromHeader(request) {
    ...
    if (acceptLanguageHeader) {
        ...
        const languages = acceptLanguageHeader
            ...
            const baseTag = (_a = tag === null || tag === void 0 ? void 0 : tag.split("-")[0]) === null || _a === void 0 ? void 0 : _a.toLowerCase();
            return {
                fullTag: tag === null || tag === void 0 ? void 0 : tag.toLowerCase(),
                baseTag,
                q: Number(q),
            };
        })
...
export function extractLocaleFromNavigator() {
    var _a;
    if (!((_a = navigator === null || navigator === void 0 ? void 0 : navigator.languages) === null || _a === void 0 ? void 0 : _a.length)) {
        return undefined;
    }
    const languages = navigator.languages.map((lang) => {
        ...
        return ({
            ...
            baseTag: (_a = lang.split("-")[0]) === null || _a === void 0 ? void 0 : _a.toLowerCase(),
        });
    });
    for (const lang of languages) {
        if (isLocale(lang.fullTag)) {
...
export function localizeUrl(url, options) {
    ...
    const targetLocale = (_a = options === null || options === void 0 ? void 0 : options.locale) !== null && _a !== void 0 ? _a : getLocale();
    const urlObj = typeof url === "string" ? new URL(url) : url;
    // Iterate over URL patterns
    for (const element of urlPatterns) {
        ...
        for (const [, localizedPattern] of element.localized) {
            ...
            const targetPattern = (_b = element.localized.find(([locale]) => locale === targetLocale)) === null || _b === void 0 ? void 0 : _b[1];
            if (!targetPattern) {
                continue;
            }
        ...
        if (unlocalizedMatch) {
            const targetPattern = (_c = element.localized.find(([locale]) => locale === targetLocale)) === null || _c === void 0 ? void 0 : _c[1];
            if (targetPattern) {
...
function localizeUrlDefaultPattern(url, options) {
    ...
    const locale = (_a = options === null || options === void 0 ? void 0 : options.locale) !== null && _a !== void 0 ? _a : getLocale();
...
function fillMissingUrlParts(url, match) {
    ...
    if (match.protocol.groups["0"]) {
        url.protocol = (_a = match.protocol.groups["0"]) !== null && _a !== void 0 ? _a : "";
    }
    if (match.hostname.groups["0"]) {
        url.hostname = (_b = match.hostname.groups["0"]) !== null && _b !== void 0 ? _b : "";
    }
    if (match.username.groups["0"]) {
        url.username = (_c = match.username.groups["0"]) !== null && _c !== void 0 ? _c : "";
    }
    if (match.password.groups["0"]) {
        url.password = (_d = match.password.groups["0"]) !== null && _d !== void 0 ? _d : "";
    }
    if (match.port.groups["0"]) {
        url.port = (_e = match.port.groups["0"]) !== null && _e !== void 0 ? _e : "";
    }
    if (match.pathname.groups["0"]) {
        url.pathname = (_f = match.pathname.groups["0"]) !== null && _f !== void 0 ? _f : "";
    }
    if (match.search.groups["0"]) {
        url.search = (_g = match.search.groups["0"]) !== null && _g !== void 0 ? _g : "";
    }
    if (match.hash.groups["0"]) {
        url.hash = (_h = match.hash.groups["0"]) !== null && _h !== void 0 ? _h : "";
    }
    return url;
}
/**
...
export function aggregateGroups(match) {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, match.hash.groups), match.hostname.groups), match.password.groups), match.pathname.groups), match.port.groups), match.protocol.groups), match.search.groups), match.username.groups);
}
/**
...
export function localizeHref(href, options) {
    ...
    const locale = (_a = options === null || options === void 0 ? void 0 : options.locale) !== null && _a !== void 0 ? _a : currentLocale;
...
export function trackMessageCall(safeModuleId, locale) {
    ...
    if (isServer === false)
        return;
    const store = serverAsyncLocalStorage === null || serverAsyncLocalStorage === void 0 ? void 0 : serverAsyncLocalStorage.getStore();
    if (store) {
        (_a = store.messageCalls) === null || _a === void 0 ? void 0 : _a.add(`${safeModuleId}:${locale}`);
    }
}
/**
