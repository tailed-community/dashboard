...
const env = function (project = "dashboard", values = {}) {
  const functionsDefaults = {
    ...
    FB_API_KEY: "demo-tailed1.key",
    FB_PROJECT_ID: "demo-tailed1",
    FB_STORAGE_BUCKET: "demo-tailed1.appspot.com",
    FB_TENANT_ID: "",
  ...
  const appDefaults = {
    ...
    VITE_FIREBASE_PROJECT_ID: "demo-tailed1",
    VITE_FIREBASE_STORAGE_BUCKET: "demo-tailed1.appspot.com",
